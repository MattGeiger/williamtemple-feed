...
function DefaultLoader() {
  return (
    <div className="bg-white/50 absolute inset-0 z-10 flex items-center justify-center backdrop-blur-xs dark:bg-slate-950/50">
      <div className="flex gap-1">
        <span className="bg-slate-500/60 size-1.5 animate-pulse rounded-full dark:bg-slate-400/60" />
        <span className="bg-slate-500/60 size-1.5 animate-pulse rounded-full [animation-delay:150ms] dark:bg-slate-400/60" />
        <span className="bg-slate-500/60 size-1.5 animate-pulse rounded-full [animation-delay:300ms] dark:bg-slate-400/60" />
      </div>
    </div>
  );
}
...
function PopupCloseButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="focus-visible:ring-slate-950 hover:bg-slate-100 text-slate-950 absolute top-1 right-1 z-10 inline-flex size-5 cursor-pointer items-center justify-center rounded-sm transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-inset dark:focus-visible:ring-slate-300 dark:hover:bg-slate-800 dark:text-slate-50"
    >
...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-white text-slate-950 relative max-w-62 rounded-md border border-slate-200 p-3 shadow-md dark:bg-slate-950 dark:text-slate-50 dark:border-slate-800",
...
function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-slate-950 text-white pointer-events-none rounded-md px-2 py-1 text-xs text-balance shadow-md dark:bg-slate-50 dark:text-slate-950",
        "animate-in fade-in-0 zoom-in-95 duration-200 ease-out",
        className,
      )}
    >
  ...
  return (
    <div
      className={cn(
        ...
        "text-slate-950 text-[10px] font-medium dark:text-slate-50",
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-slate-200 bg-white [&>button:not(:last-child)]:border-slate-200 flex flex-col overflow-hidden rounded-md border shadow-sm [&>button:not(:last-child)]:border-b dark:border-slate-800 dark:bg-slate-950 dark:[&>button:not(:last-child)]:border-slate-800">
      {children}
    </div>
  );
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:bg-slate-100 dark:hover:bg-slate-100/40 dark:hover:bg-slate-800 dark:dark:hover:bg-slate-800/40",
        "focus-visible:ring-slate-950 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset dark:focus-visible:ring-slate-300",
