    ...
    <div className="flex min-w-0 flex-col gap-2">
      ...
      <div className="flex min-w-0 flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
        ...
        <Popover open={isOpen} onOpenChange={handleOpenChange}>
          ...
          <PopoverContent
            className="w-[262px] max-w-[calc(100vw-2rem)] overflow-hidden rounded-2xl border-border/70 bg-background/40 p-0 shadow-xl backdrop-blur-[14px] backdrop-saturate-150 supports-[backdrop-filter]:bg-background/40"
            align="end"
          >
