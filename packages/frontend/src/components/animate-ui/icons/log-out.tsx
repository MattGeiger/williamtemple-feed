...
// (the user dropdown's "Log out" row). The arrow slides out through the
// doorway and returns; the door frame stays put. Geometry is Lucide v0.522.0
// `log-out` verbatim. See docs/motion/ICON_ANIMATIONS.md.
